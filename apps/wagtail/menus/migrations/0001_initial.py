# Generated by Django 3.1.4 on 2021-03-06 09:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uri_fragment', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('sub_menu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='menus.menu')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
